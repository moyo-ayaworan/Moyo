...
export default function ArtAboutPage() {
    ...
    const bioParagraphs = [
        ...
        'His practice moves between traditional and contemporary processes. Photography allows him to hold the immediacy of a body, gesture or expression; oils and acrylics create room for material transformation; and digital painting enables him to extend an image beyond the limits of the original frame.',
        'He earned an Ordinary National Diploma in General Art with Upper Credit from Yaba College of Technology in 2022. He subsequently completed a Higher National Diploma in Painting with Upper Credit at the same institution. This academic development refined his technical skills and expanded the relationship between traditional techniques and contemporary digital practice in his work.',
        'His professional development includes work with Yaba Art Museum, exhibition installation and participation in performance, museum and cross-cultural workshops. These experiences have strengthened his understanding of how artworks live in public space and how artistic meaning develops through collaboration, presentation and encounter.',
        ...
        'Based in Lagos, he draws from the energy of the city, everyday human connections and the cultural histories that surround him. His studio practice creates a dialogue between an inner world and a broader human narrative, allowing personal and collective stories to converge across materials and forms.',
        'Through the tension between light and shadow, he translates personal struggles into visual encounters that invite viewers to recognise the unspoken battles shaping relationships, memory and the self.',
    ];
                ...
                <div className="grid gap-14 lg:grid-cols-12 lg:gap-20">
                    <div className="space-y-10 lg:col-span-7 lg:space-y-16">
                        ...
                        <div className="grid gap-8 border-t border-white/10 pt-10 md:grid-cols-2">
                            <div><p className="text-[10px] uppercase tracking-[0.35em] text-accent">Education and honours</p><p className="mt-4 text-sm leading-relaxed text-white/55">2020–2022 · Ordinary National Diploma<br /><span className="text-white">General Art · Upper Credit</span><br /><br />Higher National Diploma<br /><span className="text-white">Painting · Upper Credit</span><br /><br />Yaba College of Technology, Lagos</p></div>
